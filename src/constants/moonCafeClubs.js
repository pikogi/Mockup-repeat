...
export const MOONCAFE_CLUBS = [
  ...
  },
  {
    ...
    description: 'Accede a beneficios exclusivos y descuentos en comercios aliados de Moon Café.',
    reward_text: '',
    stamps_required: 0,
    logo_url: asset('/moon-cafe-logo.png'),
    background_image_url: asset('/mooncafe-bg.jpg'),
    ...
    membership_partners: [
      {
        ...
        description: 'Presenta tu tarjeta Moon Club en el local.',
