  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
        ...
        <h1 className="text-4xl font-bold text-foreground mb-2">Menú / Catálogo</h1>
        <p className="text-lg text-gray-500 dark:text-gray-400">Mostrá tus productos y servicios de forma digital</p>
      </motion.div>
