...
const BENEFITS = [
  {
    ...
    description: 'Descuento permanente en cada visita. Aplicable en todos los gustos y formatos.',
    use_type: 'unlimited',
    tier_required: 't1',
  ...
  {
    id: 2,
    name: 'Degustación de nuevos sabores',
    description: 'Probá gratis el gusto nuevo antes de decidirte. Una muestra por visita.',
    use_type: 'monthly',
    tier_required: 't1',
  ...
  {
    id: 3,
    name: 'Descuento en paletas',
    description: '15% off en todas las paletas artesanales. Válido en cada visita.',
    use_type: 'unlimited',
    tier_required: 't2',
  ...
  {
    id: 4,
    name: 'Acceso anticipado a gustos limitados',
    description: 'Socios Plata prueban los nuevos gustos artesanales 48hs antes del lanzamiento.',
    use_type: 'unlimited',
    tier_required: 't2',
    image_url: 'https://images.unsplash.com/photo-1516559828984-fb3b99548b21?w=400&h=400&fit=crop&q=80',
  },
  {
    id: 5,
    name: 'Noche de helado artesanal',
    description: 'Eventos privados en el local con degustación guiada del maestro heladero.',
    use_type: 'unlimited',
    tier_required: 't3',
  ...
  {
    id: 6,
    name: 'Kit de bienvenida nivel Oro',
    description: 'Bolsa térmica + cuchara coleccionable + voucher de media docena. Al alcanzar Oro.',
    use_type: 'onetime',
    tier_required: 't3',
  ...
  {
    id: 7,
    name: 'Viaje a F1 São Paulo',
    description: 'Sorteo anual entre socios Oro. Incluye traslados, estadía y entrada al Gran Premio.',
    use_type: 'raffle',
    tier_required: 't3',
    image_url: 'https://images.unsplash.com/photo-1504707748692-419802cf939d?w=400&h=400&fit=crop&q=80',
  },
]
...
const POSTS = [
  {
    id: 1,
    type: 'novedad',
    title: 'Nuevo gusto: Pistacho natural',
    body: 'Pistachos naturales tostados, receta italiana. Socios Plata lo prueban primero este sábado.',
    image_url: 'https://images.unsplash.com/photo-1516559828984-fb3b99548b21?w=600&h=400&fit=crop&q=80',
    date: '2 may',
  },
  {
    id: 2,
    type: 'evento',
    title: 'Noche de helado artesanal — sáb 10',
    body: 'Degustación guiada con el maestro heladero. Cupos limitados. Solo socios Oro.',
  ...
  },
  {
    id: 3,
    type: 'promo',
    title: 'Mayo: 2x1 en Dulce de Leche Leroma',
    body: 'Todos los lunes de mayo llevás doble porción del clásico con almendras tostadas.',
  ...
  },
  {
    ...
    body: 'Durante todo mayo las tortas heladas tienen 15% de descuento para socios del Círculo.',
...
const ACTIVITY = [
  { id: 1, type: 'spent', label: 'Visita — Dulce de Leche Leroma + Pistacho', amount: '+58 pts', date: '2 may 2026' },
  { id: 2, type: 'redeemed', label: 'Degustación gusto del mes', date: '2 may 2026' },
  { id: 3, type: 'referral', label: 'Referido — Luciana Peralta', date: '25 abr 2026' },
  { id: 4, type: 'spent', label: 'Visita — media docena artesanal', amount: '+92 pts', date: '18 abr 2026' },
  { id: 5, type: 'redeemed', label: '10% off en helados', date: '18 abr 2026' },
  { id: 6, type: 'spent', label: 'Visita — Mango Maracuyá + Chocolate Rocher', amount: '+44 pts', date: '10 abr 2026' },
]

const MEMBER_SPEND = 800
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/50 text-xs mt-0.5">Subí de nivel y desbloqueá más experiencias</p>
                  </div>
                </div>
          ...
          {step === 'success' && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Ya podés usar tus nuevas experiencias.</p>
              </div>
              {levelUp && (
                <motion.div
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Ahora tenés acceso a nuevas experiencias.</p>
                  </div>
                </motion.div>
              )}
              <Button
...
const GIFT_CARD_OPTIONS = [
  ...
  {
    id: 4,
    label: '1 kg de helado',
    desc: 'Gift card especial · 1 kilo de helado artesanal a elección',
    price: '$8.500',
    type: 'product',
  },
]
          ...
          {!sent ? (
            <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              <div
                ...
                style={{ background: `linear-gradient(135deg, ${COLOR} 0%, #333 100%)` }}
              >
                <button
                  onClick={onClose}
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Regala Leroma</p>
          </div>
                      ...
                      style={{
                        background:
                          card.type === 'product'
                            ...
                            : `linear-gradient(135deg, ${COLOR} 0%, #333 100%)`,
                      }}
                    >
                      ...
                      <div className="px-4 py-3 bg-black/20 flex items-center justify-between">
                        <span className="text-white text-xs font-bold">
                          {card.type === 'product' ? `Regalar · ${card.price}` : `Regalar · ${card.price}`}
                        </span>
...
function BenefitModal({ benefit, onClose, onSuccess }) {
  ...
  const [code] = useState(() => 'LRM-' + Math.random().toString(36).slice(2, 6).toUpperCase())
  const meta = USE_TYPE_META[benefit.use_type]
...
export default function PublicMembershipLeroma() {
  ...
  const handleShare = async () => {
    const url = `${window.location.origin}/membership/leroma-membership-demo`
    try {
  ...
  return (
    ...
    >
      {/* Sticky header — same dark style as Leroma catalog */}
      <div className="sticky top-0 z-10 border-b shadow-sm" style={{ background: '#111111', borderColor: '#222' }}>
        ...
        <div
          ...
          style={{ backgroundColor: COLOR, borderTop: '1px solid rgba(255,255,255,0.1)' }}
        >
          <div className="flex whitespace-nowrap" style={{ animation: 'marquee 18s linear infinite' }}>
            {[...Array(6)].map((_, i) => (
              <span key={i} className="text-white text-xs font-medium px-8">
                🍦 Dulce de Leche Leroma · 🍵 Pistacho natural · 🥭 Mango Maracuyá · 🍫 Chocolate Rocher · 🎉 Eventos
                privados · ✨ Gustos nuevos cada mes
              </span>
            ))}
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        {/* Member card — same structure as catalog points banner */}
        {loggedIn ? (
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          /* Anonymous view — same style as catalog */
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
              ...
              {!showEmailLookup ? (
                  ...
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">
                        Accedé a degustaciones, eventos y experiencias exclusivas.
                      </p>
                      <button
                        ...
                        style={{ color: COLOR }}
                      >
                        ¿Ya sos socio? Ver mis experiencias →
                      </button>
                    </div>
                  </div>
                  <a
                    href="/publicprogram?id=leroma-membership-demo"
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-gray-800">Ingresá tu email para ver tus experiencias</p>
                  </div>
              ...
              >
                <div className="px-4 pb-4 space-y-2.5">
                  {[
                    ...
                    {
                      step: '2',
                      text: 'Con cada compra acumulás puntos y subís de nivel para desbloquear más experiencias.',
                    },
                    { step: '3', text: 'Generá un cupón por cada experiencia y presentalo en caja para usarlo.' },
                  ].map((s) => (
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-gray-900 leading-none">Experiencias</h2>
            </div>
            {loggedIn && (
              <p className="text-sm text-gray-500">
