...
export default function NotificationsMoonCafePoints() {
                ...
                <CardContent className="pt-6 space-y-6">
                    ...
                    {audience === 'club' && (
                      <Select value={club} onValueChange={setClub}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="mooncafe">Club de Puntos Moon Cafe</SelectItem>
                        </SelectContent>
                      </Select>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Ej: Pasá por Moon Cafe y sumá puntos extra en tu próxima visita."
                      maxLength={BODY_MAX}
                      rows={4}
                    />
                  </div>
