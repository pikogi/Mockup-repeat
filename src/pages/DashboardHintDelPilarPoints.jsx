...
const STEPS = [
  {
    iframe: '/dashboard/del-pilar-points-demo',
    iframeKey: 0,
  ...
  {
    iframe: '/customers/del-pilar-points-demo',
    iframeKey: 1,
    title: 'Tus miembros',
  ...
  {
    iframe: '/notifications/del-pilar-points-demo',
    iframeKey: 3,
...
export default function DashboardHintDelPilarPoints() {
