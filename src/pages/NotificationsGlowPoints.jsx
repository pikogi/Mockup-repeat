...
export default function NotificationsGlowPoints() {
    ...
    setHistory([
      {
        ...
        body,
        program:
          audience === 'todos' ? 'Todos los programas' : audience === 'club' ? 'Club de Puntos Glow' : 'Por sucursal',
        sent_at: new Date().toISOString(),
        recipients: 186,
      },
      ...history,
    ])
    toast.success('Notificación enviada a 186 clientas')
    setHeader('')
    setBody('')
  }
    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Enviá notificaciones push a las clientas de tus programas.</p>
        </motion.div>
                ...
                <CardContent className="pt-6 space-y-6">
                    ...
                    {audience === 'sucursal' && (
                      <Select value={sucursal} onValueChange={setSucursal}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="s1">Glow Centro</SelectItem>
                        </SelectContent>
                      </Select>
                    )}
                    {audience === 'club' && (
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Ej: ¡Doble puntos esta semana!"
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Ej: Pasá por Glow esta semana y sumá el doble de puntos en tu tratamiento."
                      maxLength={BODY_MAX}
                      rows={4}
                    />
                  </div>
