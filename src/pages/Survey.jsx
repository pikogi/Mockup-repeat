  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      >
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Encuesta de Satisfacción</h1>
        <p className="text-lg text-gray-500">Conoce la experiencia real de tus clientes</p>
      </motion.div>
      ...
      >
        <Card className="p-6 bg-white border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-600 leading-relaxed">
            La encuesta de satisfacción te permite conocer de primera mano qué piensan tus
            clientes sobre su experiencia en tu negocio: qué les gusta, qué no y qué podrías
            mejorar. Con esa información, podrás tomar decisiones más inteligentes y ofrecer
            experiencias cada vez mejores.
          </p>
        </Card>
      </motion.div>
