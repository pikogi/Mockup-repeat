...
const STEPS = [
  {
    iframe: '/dashboard/glow-points-demo',
    iframeKey: 0,
    title: 'Tu panel de control',
    desc: 'Desde acá vas a ver métricas de tu programa: miembros, puntos otorgados y premios canjeados.',
    btn: 'Ver miembros →',
  },
  {
    iframe: '/customers/glow-points-demo',
    iframeKey: 1,
    title: 'Tus miembros',
    desc: 'Acá aparecen todas las miembros que se unieron a tu programa de puntos. Tocá uno para ver su historial.',
    btn: null,
  },
  {
    iframe: '/customers/glow-points-demo',
    ...
    desc: 'Podés ver sus visitas, puntos acumulados, premios canjeados y agregar puntos manualmente.',
    btn: 'Ver notificaciones →',
    cardTop: true,
    compact: true,
  },
  {
    iframe: '/notifications/glow-points-demo',
    iframeKey: 3,
...
export default function DashboardHintGlowPoints() {
