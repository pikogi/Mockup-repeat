...
const STEPS = [
  {
    iframe: '/dashboard/mooncafe-points-demo',
    iframeKey: 0,
  ...
  {
    iframe: '/customers/mooncafe-points-demo',
    iframeKey: 1,
    title: 'Tus miembros',
  ...
  {
    iframe: '/notifications/mooncafe-points-demo',
    iframeKey: 3,
...
export default function DashboardHintMoonCafePoints() {
