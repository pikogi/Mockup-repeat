...
export default function ResetPassword() {
  ...
  const updatePasswordMutation = useMutation({
    ...
    onError: (error) => {
      const errorMessage = error.response?.data?.message || error.message || t('resetErrorToast')
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !token) {
      toast.error(t('resetInvalidLinkDesc'))
      return
    }
        ...
        >
          <Card className="bg-white shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="pt-2">{t('resetInvalidLinkDesc')}</CardDescription>
            </CardHeader>
        ...
        <Card className="bg-white shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-bold text-gray-900">
              {updatePasswordMutation.isSuccess ? t('resetSuccessTitle') : t('resetTitle')}
            </CardTitle>
            <CardDescription className="text-base pt-2">
              {updatePasswordMutation.isSuccess ? t('resetSuccessDesc') : t('resetFormDesc')}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            {!updatePasswordMutation.isSuccess ? (
              ...
              <Button onClick={() => navigate('/login')} className="w-full h-12 bg-black hover:bg-gray-800 text-white">
                {t('goToLogin')}
              </Button>
            )}
