...
const AUTOMATIONS_DEFAULT = [
  {
    ...
    enabled: true,
    header: '¡Bienvenido/a a Círculo Leroma! 🍦',
  ...
  },
  {
    ...
    body: 'Alcanzaste un nuevo nivel en Círculo Leroma. Chequeá tus nuevos beneficios disponibles.',
    extra: null,
  },
  {
    id: 'birthday',
    ...
    body: 'En tu día te regalamos 100 puntos extra. Pasá por Leroma y celebrá con tu gusto favorito.',
    extra: null,
  },
  {
    id: 'inactivity',
    ...
    body: 'Hace tiempo que no pasás por Leroma. Volvé y seguí sumando puntos hacia tu próximo premio.',
...
export default function NotificationsLeroma() {
    ...
    setHistory([
      {
        ...
        header,
        body,
        program: audience === 'todos' ? 'Todos los programas' : audience === 'club' ? 'Círculo Leroma' : 'Por sucursal',
        sent_at: new Date().toISOString(),
        recipients: 342,
      },
      ...history,
    ])
    toast.success('Notificación enviada a 342 miembros')
    setHeader('')
    setBody('')
  }
                    ...
                    <CardContent className="pt-6 space-y-6">
                        ...
                        {audience === 'club' && (
                          <Select value={club} onValueChange={setClub}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="leroma">Círculo Leroma</SelectItem>
                            </SelectContent>
                          </Select>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          placeholder="Ej: Pasá por Leroma y sumate al doble de puntos por cada helado."
                          maxLength={BODY_MAX}
                          rows={4}
                        />
                      </div>
