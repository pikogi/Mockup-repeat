...
const CHART_7D = [
  { date: '30 abr', fullDate: '30 de abril', adds: 6, scans: 95, redemptions: 8, nuevos: 6, recurrentes: 89 },
  { date: '1 may', fullDate: '1 de mayo', adds: 9, scans: 125, redemptions: 10, nuevos: 9, recurrentes: 116 },
  { date: '2 may', fullDate: '2 de mayo', adds: 11, scans: 140, redemptions: 12, nuevos: 11, recurrentes: 129 },
  { date: '3 may', fullDate: '3 de mayo', adds: 8, scans: 130, redemptions: 11, nuevos: 8, recurrentes: 122 },
  { date: '4 may', fullDate: '4 de mayo', adds: 5, scans: 80, redemptions: 7, nuevos: 5, recurrentes: 75 },
  { date: '5 may', fullDate: '5 de mayo', adds: 4, scans: 72, redemptions: 6, nuevos: 4, recurrentes: 68 },
  { date: '6 may', fullDate: '6 de mayo', adds: 7, scans: 105, redemptions: 7, nuevos: 7, recurrentes: 98 },
]

const CHART_MONTH = [
  { date: '7 abr', fullDate: '7 de abril', adds: 5, scans: 78, redemptions: 6, nuevos: 5, recurrentes: 73 },
  { date: '9 abr', fullDate: '9 de abril', adds: 8, scans: 102, redemptions: 9, nuevos: 8, recurrentes: 94 },
  { date: '11 abr', fullDate: '11 de abril', adds: 6, scans: 91, redemptions: 7, nuevos: 6, recurrentes: 85 },
  { date: '14 abr', fullDate: '14 de abril', adds: 12, scans: 145, redemptions: 13, nuevos: 12, recurrentes: 133 },
  { date: '16 abr', fullDate: '16 de abril', adds: 4, scans: 67, redemptions: 5, nuevos: 4, recurrentes: 63 },
  { date: '18 abr', fullDate: '18 de abril', adds: 9, scans: 118, redemptions: 10, nuevos: 9, recurrentes: 109 },
  { date: '21 abr', fullDate: '21 de abril', adds: 14, scans: 162, redemptions: 14, nuevos: 14, recurrentes: 148 },
  { date: '23 abr', fullDate: '23 de abril', adds: 7, scans: 99, redemptions: 8, nuevos: 7, recurrentes: 92 },
  { date: '25 abr', fullDate: '25 de abril', adds: 10, scans: 133, redemptions: 11, nuevos: 10, recurrentes: 123 },
  { date: '28 abr', fullDate: '28 de abril', adds: 11, scans: 141, redemptions: 12, nuevos: 11, recurrentes: 130 },
  { date: '30 abr', fullDate: '30 de abril', adds: 6, scans: 95, redemptions: 8, nuevos: 6, recurrentes: 89 },
  { date: '2 may', fullDate: '2 de mayo', adds: 11, scans: 140, redemptions: 12, nuevos: 11, recurrentes: 129 },
  { date: '4 may', fullDate: '4 de mayo', adds: 5, scans: 80, redemptions: 7, nuevos: 5, recurrentes: 75 },
  { date: '6 may', fullDate: '6 de mayo', adds: 7, scans: 105, redemptions: 7, nuevos: 7, recurrentes: 98 },
...
const TIER_DIST = [
  { name: 'Bronce', value: 198, fill: '#cd7f32' },
  { name: 'Plata', value: 102, fill: '#9ca3af' },
  { name: 'Oro', value: 42, fill: '#f59e0b' },
]

const MEMBER_ORIGIN = [
  { name: 'QR en sucursal', value: 198, fill: '#111111' },
  { name: 'Referido', value: 87, fill: '#374151' },
  { name: 'Link directo', value: 57, fill: '#9ca3af' },
]

const TOP_BENEFITS = [
  { name: '10% off helados', canjes: 98, fill: '#f59e0b' },
  { name: 'Degustación', canjes: 64, fill: '#f97316' },
  { name: 'Descuento paletas', canjes: 47, fill: '#ef4444' },
  { name: 'Acceso anticipado', canjes: 23, fill: '#8b5cf6' },
  { name: 'Kit bienvenida', canjes: 15, fill: '#3b82f6' },
]

const SUCURSALES_RANKING = [
  { name: 'Sucursal 1', visitas: 412, fill: '#111111' },
  { name: 'Sucursal 2', visitas: 338, fill: '#374151' },
  { name: 'Sucursal 3', visitas: 291, fill: '#6b7280' },
  { name: 'Sucursal 4', visitas: 198, fill: '#9ca3af' },
]

const SUCURSALES_TIERS = [
  { name: 'Sucursal 1', bronce: 210, plata: 140, oro: 62 },
  { name: 'Sucursal 2', bronce: 175, plata: 110, oro: 53 },
  { name: 'Sucursal 3', bronce: 158, plata: 95, oro: 38 },
  { name: 'Sucursal 4', bronce: 112, plata: 62, oro: 24 },
]
