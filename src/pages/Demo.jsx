...
const COL_RIGHT = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: 'Dashboard · Del Pilar',
        url: '/dashboard/del-pilar-demo',
        desc: 'Dashboard con métricas y gráficos. Panadería artesanal.',
        single: true,
        mobile: false,
      },
      {
        label: 'Miembros · Del Pilar',
        url: '/customers/del-pilar-demo',
        desc: 'Lista de miembros con puntos, visitas y premios.',
        single: true,
        mobile: false,
      },
      {
        label: 'Mis programas · Del Pilar',
        url: '/myprograms/del-pilar-demo',
        desc: 'Lista de programas con gestión. Panadería.',
        single: true,
        mobile: false,
      },
      {
        label: 'Notificaciones · Del Pilar',
        url: '/notifications/del-pilar-demo',
        desc: 'Envío de push notifications a miembros.',
        single: true,
        mobile: false,
      },
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: 'Del Pilar',
        url: '/catalog/del-pilar-demo',
        desc: 'Catálogo de premios. Panadería artesanal.',
        single: true,
      },
    ],
  },
