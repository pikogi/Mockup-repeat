...
import { Users, DollarSign, TrendingUp, UserPlus, RefreshCw, TrendingDown, AlertTriangle, Clock3 } from 'lucide-react'
    ...
    <div className="px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-0.5">Panorama general del programa de membresías</p>
        </div>
