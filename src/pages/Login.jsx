    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900 p-4 relative overflow-hidden">
      ...
      >
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3, duration: 0.5 }}>
          <Card className="w-full border-0 shadow-2xl backdrop-blur-md bg-white/95 dark:bg-gray-900/95 hover:bg-white/98 dark:hover:bg-gray-900/98 transition-all duration-300">
            <CardHeader className="text-center pb-8 pt-10">
              ...
              >
                <motion.h1
                  className="text-5xl font-bold bg-gradient-to-r from-black via-gray-800 to-black dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent mb-2"
                  animate={{
              ...
              >
                <p className="text-lg text-gray-600 dark:text-gray-400 font-medium min-h-[28px]">
                  <Typewriter text="What your clients love 💛" speed={80} delay={800} />
                </p>
              </motion.div>
            ...
            >
                  ...
                  >
                    ...
                    <motion.div whileFocus={{ scale: 1.01 }} transition={{ duration: 0.2 }}>
                      <Input
                        ...
                        required={!isLogin}
                        className="h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-yellow-500 focus:ring-yellow-500/20 transition-all duration-300"
                      />
                    </motion.div>
                  </motion.div>
                )}
                ...
                >
                  ...
                  <motion.div whileFocus={{ scale: 1.01 }} transition={{ duration: 0.2 }} className="relative">
                    <Input
                      ...
                      required
                      className="h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-yellow-500 focus:ring-yellow-500/20 transition-all duration-300 pr-10"
                    />
                    <button
                      type="button"
                  ...
                  {!isLogin && formData.password && (
                    ...
                    >
                      <div
                        className={`flex items-center gap-2 ${passwordValidation.requirements.hasMinLength ? 'text-green-600' : 'text-red-600'}`}
                      >
              ...
              >
                <motion.button
                  ...
                  className="text-sm text-gray-600 dark:text-gray-400 hover:text-yellow-600 font-medium transition-colors"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
