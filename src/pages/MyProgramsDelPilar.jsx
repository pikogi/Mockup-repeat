...
const DEL_PILAR_CARDS = [
  {
    id: 'panaderia-demo',
    club_name: 'Club Del Pilar',
    card_title: 'Programa de Puntos',
    reward_text: 'Canjeá puntos por café, medialunas y productos de la panadería',
    card_color: '#f5c100',
    is_active: true,
    total_scans: 829,
    description: 'Acumulá puntos en cada visita y canjealos por tus favoritos de Del Pilar.',
...
export default function MyProgramsDelPilar() {
  const [searchQuery, setSearchQuery] = useState('')

  const filtered = DEL_PILAR_CARDS.filter(
    (c) =>
