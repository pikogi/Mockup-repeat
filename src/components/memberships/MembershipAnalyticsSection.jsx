...
// Contenido de Analytics, embebido como pestaña dentro del Dashboard de membresías
// (antes vivía en su propia ruta /memberships/analytics).
export default function MembershipAnalyticsSection({ data }) {
