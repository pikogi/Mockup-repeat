      ...
      {[1, 2, 3].map((i) => (
        <Card key={i} className="overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-48 h-48 md:h-auto bg-gray-200 dark:bg-gray-700 animate-pulse flex-shrink-0" />
            <div className="flex-1 p-6 space-y-4">
              ...
              <div className="w-full h-3 bg-gray-100 dark:bg-gray-800 rounded animate-pulse" />
              <div className="w-3/4 h-3 bg-gray-100 dark:bg-gray-800 rounded animate-pulse" />
              <div className="flex gap-2 mt-2">
                {[1, 2, 3, 4].map((j) => (
                  <div key={j} className="w-24 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse" />
                ))}
              </div>
            </div>
          </div>
  ...
  return (
    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-20">
      <div className="max-w-md mx-auto">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">{t('noProgramsTitle')}</h3>
        <p className="text-gray-600 dark:text-gray-400 mb-6">{t('noProgramsDesc')}</p>
